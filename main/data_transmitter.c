...
#define TX_BUFF_SIZE (1024*16) //16k por las dudas
...
}registeredSensors[30];



void dataTransmitterInit(void)
{
	for(int i=0;i<MAX_SENSORS;i++) registeredSensors[i].sensorRead = NULL; //para marcar los slots libres
